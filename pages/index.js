  ...
  return (
    <div className='container mx-auto bg-network'>
      ...
      <div>
        ...
        <div className='grid  leading-none bg-white rounded-lg shadow-lg py-6 px-12'>
          <div className=''>
      ...
      <div>
        <h3 className='text-4xl font-bold text-orange text-center uppercase mt-10'>Tech contribuitons</h3>
        ...
        <div className='grid grid-cols-3 gap-4 my-6'>
          {repos.map(repo => {
            return (
              <div key={repo.id} className='rounded bg-gray-200 p-4 hover:shadow-md'>
